...
ReviewCard.propTypes = {
  name: PropTypes.string.isRequired, // Example: "John Doe"
  designation: PropTypes.string.isRequired, // Example: "Customer"
  review: PropTypes.string.isRequired, // Example: "This is a great product."
};
